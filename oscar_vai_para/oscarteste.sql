...
SELECT year_ceremony, category, film, name from movies where category in ('BEST PICTURE','ACTRESS','DIRECTING') and year_ceremony ='2003' and winner like '1';
...
-- Meu irmão, ele sempre acreditou em mim e no meu potencial, ele merece tudo o que a de bom no mundo por ser um ser humano tão incrivel. 
